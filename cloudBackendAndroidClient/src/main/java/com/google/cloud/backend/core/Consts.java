...
public interface Consts {
     ...
     */
    public static final String PROJECT_ID = "coral-gate-535";

    /**
     * Set Project Number of your Google APIs Console Project.
     */
    public static final String PROJECT_NUMBER = "728682819028";

    /**
     * Set your Web Client ID for authentication at backend.
     */
    public static final String WEB_CLIENT_ID = "728682819028.apps.googleusercontent.com";
